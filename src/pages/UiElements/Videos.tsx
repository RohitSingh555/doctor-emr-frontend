...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | CareMan - React.js Admin Dashboard Template"
        description="This is React.js Videos page for CareMan - React.js Tailwind CSS Admin Dashboard Template"
      />
