...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | CareMan - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for CareMan - React.js Tailwind CSS Admin Dashboard Template"
      />
